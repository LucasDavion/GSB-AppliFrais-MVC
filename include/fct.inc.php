 ...
 * @param $montant
 */
function valideInfosFrais($dateFrais,$lstLibelle,$montant){
	if($dateFrais==""){
...
function getDateDernierJourMoisPrecedent(){
  ...
  $mois--;
  $nbJourMoisPasse=cal_day_in_month(CAL_GREGORIAN,date('m',$mois),date('Y',$annee));
  return $nbJourMoisPasse."/".$mois."/".$annee;
}
?>
